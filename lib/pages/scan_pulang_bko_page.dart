...
import 'package:cobra_apps/pages/absen_pulang_bko_page.dart';
import 'dart:convert';
...
class ScanPulangBkoPage extends ConsumerStatefulWidget {
  final Map<String, dynamic>? data;
  const ScanPulangBkoPage({super.key, this.data});

  @override
  ConsumerState<ScanPulangBkoPage> createState() => _ScanPulangBkoPageState();
}
        ...
        if (!providerState.navigated && data['success'] == true) {
          ...
          if (maxDistance != null &&
            ...
            Navigator.of(context).pushReplacement(
              MaterialPageRoute(builder: (_) => AbsenPulangBkoPage(data: data)),
            );
          }
        }
